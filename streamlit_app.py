...
mem_requests = st.slider("Memory Requests for an app", 0.0, 64.0, 0.8, 0.1)
...
min_cores_per_node = math.ceil(avg_idle_per_node * (0.05 + manager_cores_idle) + avg_active_per_node * (1.0 + manager_cores_active) + per_node_system_cores)
